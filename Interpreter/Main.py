...
if dataType==1:
    ...
    for numOfNeeds
    listOfNeeds= [] ## make a list of the things tha you need (input from person themselves?)
    ## for loop to fill what is needed in the code (wether an array or anything)
